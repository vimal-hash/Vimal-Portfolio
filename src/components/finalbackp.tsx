  ...
  return (
    <>
      <group ref={groupRef} visible={ready} {...({} as any)}>
        <mesh ref={Cube002} castShadow receiveShadow name="Cube002" geometry={nodes.Cube007.geometry as any} material={materials['Material.009'] as any} position={[7.048, 0.664, -1.984]} />
